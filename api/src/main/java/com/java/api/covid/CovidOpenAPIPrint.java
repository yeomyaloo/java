...
public class CovidOpenAPIPrint {
        public static void main(String[] args) throws IOException {


            /**자바를 사용해서 해당 공공데이터를 받아오는 방법**/
            //url 생성
            ...
            /** 위에는 공공데이터를 받아오는 방법이다.
             * 받아온 데이터를 JSON으로 파싱해주어야 한다. (XML 형식임)
             * 또한 필요 목적에 맞게 데이터를 가공하면 된다.
             * **/
